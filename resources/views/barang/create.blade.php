	...
	<div class="tab-pane active" id="horizontal-form">
		<form class="form-horizontal" method="post" action="#">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control1" id="focusedinput" placeholder="" name="kode_barang">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control1" id="focusedinput" placeholder="" name="lokasi_barang">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="number" class="form-control1" id="focusedinput" placeholder="" name="stok_barang">
				</div>
			</div>
